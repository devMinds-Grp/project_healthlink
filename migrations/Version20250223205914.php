 ...
 */
final class Version20250223205914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE care_response (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, care_id INT NOT NULL, date_rep DATE NOT NULL, contenu_rep VARCHAR(255) DEFAULT NULL, INDEX IDX_6888AE46A76ED395 (user_id), INDEX IDX_6888AE46F270FD45 (care_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, care_response_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, num_tel VARCHAR(8) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, speciality VARCHAR(50) DEFAULT NULL, categorie_soin VARCHAR(50) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, statut VARCHAR(20) DEFAULT \'en attente\' NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), INDEX IDX_1D1C63B3D60322AC (role_id), INDEX IDX_1D1C63B3C1B1AE5F (care_response_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
