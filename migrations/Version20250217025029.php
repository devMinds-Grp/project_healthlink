 ...
 */
final class Version20250217025029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE care ADD patient_id INT DEFAULT NULL, ADD care_user_id INT DEFAULT NULL, DROP care_his_id, DROP care_patient_id');
        ...
        $this->addSql('ALTER TABLE forum ADD is_approved TINYINT(1) NOT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur ADD role_id INT NOT NULL, ADD care_response_id INT DEFAULT NULL, ADD num_tel VARCHAR(8) DEFAULT NULL, ADD adresse VARCHAR(255) DEFAULT NULL, ADD speciality VARCHAR(50) DEFAULT NULL, ADD categorie_soin VARCHAR(50) DEFAULT NULL, ADD image VARCHAR(255) DEFAULT NULL, ADD statut VARCHAR(20) DEFAULT \'en attente\' NOT NULL, DROP role');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE care ADD care_his_id INT DEFAULT NULL, ADD care_patient_id INT DEFAULT NULL, DROP patient_id, DROP care_user_id');
        ...
        $this->addSql('ALTER TABLE forum DROP is_approved');
        ...
        $this->addSql('ALTER TABLE utilisateur ADD role VARCHAR(255) NOT NULL, DROP role_id, DROP care_response_id, DROP num_tel, DROP adresse, DROP speciality, DROP categorie_soin, DROP image, DROP statut');
    }
}
