 ...
 */
final class Version20250214160620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Appointment (id INT AUTO_INCREMENT NOT NULL, doctor_id INT NOT NULL, patient_id INT NOT NULL, date DATE NOT NULL, statut VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_78A4779387F4FB17 (doctor_id), INDEX IDX_78A477936B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE care (id INT AUTO_INCREMENT NOT NULL, caregiver_id INT NOT NULL, patient_id INT NOT NULL, care_user_id INT DEFAULT NULL, date DATE NOT NULL, address VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_6113A84541946261 (caregiver_id), INDEX IDX_6113A8456B899279 (patient_id), INDEX IDX_6113A845E70F4DA0 (care_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prescription (id INT AUTO_INCREMENT NOT NULL, card_user_id INT DEFAULT NULL, rdvcard_id INT DEFAULT NULL, nom_medicament VARCHAR(255) NOT NULL, dosage VARCHAR(255) NOT NULL, duree VARCHAR(255) NOT NULL, notes VARCHAR(255) NOT NULL, INDEX IDX_1FBFB8D9F07459E3 (card_user_id), UNIQUE INDEX UNIQ_1FBFB8D9AD263032 (rdvcard_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, rec_cat_id INT DEFAULT NULL, patient_id INT NOT NULL, admin_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, statut_reclamation VARCHAR(255) NOT NULL, INDEX IDX_CE606404DB54CFDE (rec_cat_id), INDEX IDX_CE6064046B899279 (patient_id), INDEX IDX_CE606404642B8210 (admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, care_response_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, num_tel VARCHAR(20) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, speciality VARCHAR(50) DEFAULT NULL, categorie_soin VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), INDEX IDX_1D1C63B3D60322AC (role_id), INDEX IDX_1D1C63B3C1B1AE5F (care_response_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
